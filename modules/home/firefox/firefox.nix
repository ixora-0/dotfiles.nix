...
in {
  ...
  programs.firefox.profiles."nixOS-profile" = default-config // {
  ...
  programs.firefox.profiles."nosuggest" = default-config // {
    ...
    settings = {
      ...
      # Disable bookmark suggestions
      "browser.urlbar.suggest.bookmark" = false;
      # Disable top sites / shortcuts
      "browser.urlbar.suggest.topsites" = false;
      # Disable Firefox suggestions / sponsored content
